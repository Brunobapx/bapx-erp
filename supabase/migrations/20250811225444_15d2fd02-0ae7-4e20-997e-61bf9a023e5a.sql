-- Enforce company isolation for sellers and users across companies
-- 1) Enable RLS and add policies on user_positions
DO $$ BEGIN
  PERFORM 1 FROM pg_tables WHERE schemaname = 'public' AND tablename = 'user_positions';
  IF FOUND THEN
    ...
    EXECUTE $$
      CREATE POLICY user_positions_company_access
...
DO $$ BEGIN
  ...
  IF FOUND THEN
    ...
    EXECUTE $$
      CREATE POLICY user_roles_company_access
