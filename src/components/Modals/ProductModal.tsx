  ...
  useEffect(() => {
    if (productData) {
      setFormData({
        ...
        weight: productData.weight !== undefined && productData.weight !== null ? Number(productData.weight).toFixed(3) : '',
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const productPayload = {
        ...
        weight: formData.weight !== undefined && formData.weight !== '' ? parseFloat(String(formData.weight).replace(',', '.')) : null,
        unit: formData.unit,
