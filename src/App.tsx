...
// Componente que verifica se é rota de e-commerce
function AppContent() {
  const location = useLocation();
  const isEcommercePage = location.pathname.startsWith('/loja/');

  console.log("App route check:", { pathname: location.pathname, isEcommercePage });

  // Para rotas de e-commerce, renderizar sem AuthProvider
  if (isEcommercePage) {
    return (
      <Routes>
  ...
  // Para outras rotas, usar AuthProvider normal
  return (
    <AuthProvider>
      <FinancialProvider>
        <Routes>
